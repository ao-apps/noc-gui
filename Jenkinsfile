...
def upstreamProjects = [
	...
	'monitor/api', // <groupId>com.aoindustries</groupId><artifactId>noc-monitor-api</artifactId>
	'monitor/impl', // <groupId>com.aoindustries</groupId><artifactId>noc-monitor-impl</artifactId>
	'monitor/rmi-client', // <groupId>com.aoindustries</groupId><artifactId>noc-monitor-rmi-client</artifactId>
	// No Jenkins: <groupId>org.swinglabs.swingx</groupId><artifactId>swingx-core</artifactId>

	// Runtime Direct
	// No Jenkins: <groupId>org.slf4j</groupId><artifactId>slf4j-jdk14</artifactId>
]
