...
public class Noc {
  ...
  public Noc(Container parent) throws IOException {
    ...
    if (parent != null) {
      ...
      currentDisplayMode = preferences.getDisplayMode();
    }
    ...
    if (parent == null && SystemTray.isSupported()) {
      ...
      if (trayIconSize.width == 24 && trayIconSize.height == 24) {
        ...
        if (logger.isLoggable(Level.WARNING)) {
          logger.warning("Warning: Scaling tray image to " + trayIconSize.width + "x" + trayIconSize.height);
        }
  ...
  Component getDefaultDialogOwner() {
    ...
    if (preferences.getDisplayMode() == Preferences.DisplayMode.TABS) {
      ...
      if (alertsFrame.isActive()) {
        return alertsFrame;
      }
      if (communicationFrame.isActive()) {
        return communicationFrame;
      }
      if (systemsFrame.isActive()) {
        return systemsFrame;
      }
      return communicationFrame;
    }
  ...
  private final ChangeListener changeListener = (ChangeEvent e) -> {
    ...
    if (!ignoreChangeEvent) {
      ...
      if (selectedIndex != -1) {
        preferences.setTabbedPaneSelectedIndex(selectedIndex);
      }
    }
  };
  ...
  private void initTabs(Container parent) {
    ...
    if (componentAtAlertsTabIndex != alerts) {
      throw new AssertionError("ALERTS_TAB_INDEX is incorrect: " + componentAtAlertsTabIndex);
    }
  }
  ...
  void loginCompleted(
    ...
    if (singleLoginButton != null) {
      singleLoginButton.setText(logoutLabel);
    }
    if (alertsLoginButton != null) {
      alertsLoginButton.setText(logoutLabel);
    }
    if (communicationLoginButton != null) {
      communicationLoginButton.setText(logoutLabel);
    }
    if (systemsLoginButton != null) {
      systemsLoginButton.setText(logoutLabel);
    }
    if (trayIcon != null) {
  ...
  final void logout() {
    ...
    if (singleLoginButton != null) {
      singleLoginButton.setText(loginLabel);
    }
    if (alertsLoginButton != null) {
      alertsLoginButton.setText(loginLabel);
    }
    if (communicationLoginButton != null) {
      communicationLoginButton.setText(loginLabel);
    }
    if (systemsLoginButton != null) {
      systemsLoginButton.setText(loginLabel);
    }
    if (trayIcon != null) {
